...
If the grower had not participated in the experiment, the chosen strategy would have been to apply _input_full_name_l_ according to _uniform_Rx_ displayed in the first panel of figure \@ref(fig:mix-figures).
...
```{r mix-figures, fig.cap = "Estimated Optimal site-specific _input_full_name_l_ rate Rx", fig.height  = 4}
