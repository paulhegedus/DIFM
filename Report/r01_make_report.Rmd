...
field_var_txt <- data.table(field_vars = field_vars) %>% 
  ...
  .[1, var_txt_in_report := str_to_title(var_txt_in_report)] %>% 
...
`r field_var_txt` were tested to see if they are correlated with the management zones. Among these variables, `r int_var_txt` seem to affect how yield responds to _input_full_name_l_. 
