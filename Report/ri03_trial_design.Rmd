Figure \@ref(fig:tgti-yield-ap) displays the trial design and the resultant as-applied map.  Casual observation shows that <!--NEED to determine and assign:  "trial implementation was basically accurate", or "the accuracy of trial implementation was limited by" (add text by hand) -->.  
...
```{r tgti-yield-ap, fig.cap = "Trial design, as-applied nitrogen rates, and corn yields, 2020)", fig.height = 10}
