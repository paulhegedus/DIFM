...
```{r mix-figures, fig.cap = "Estimated Optimal site-specific _input_full_name_l_ rate Rx", fig.height  = 5}
...
```{r profit-dif-map, fig.cap = "Map of the difference in profits between the optimal and Rx", fig.height = 5}
tm_pi_dif_zones 
```
