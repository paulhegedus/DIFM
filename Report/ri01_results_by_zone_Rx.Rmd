...
If the grower had not participated in the experiment, the chosen strategy would have been to apply _input_full_name_l_ according to the commericial variable-rate prescription displayed in Figure \@ref(fig:rx-input-map).
