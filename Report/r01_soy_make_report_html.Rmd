...
```{r tgts-yield-ap-gg, fig.cap = "Trial design, as-planted seed rates, and soybean yields, 2020)", fig.height = 8.5, eval = F}
...
```{r tgts-yield-ap, fig.cap = "Trial design, as-planted seed rates, and soybean yields, 2020)", fig.height = 10}
