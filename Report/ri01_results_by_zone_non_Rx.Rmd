...
g_pi <- ggplot(data = fig_data) +
  ...
  geom_text(
    aes(
      ...
      x = type_txt,
      label = paste0("_input_full_name_here_c_ rate \n = ", round(input_rate)) 
    ), 
    size = 4, 
    family = "Times",
    color = "blue"
