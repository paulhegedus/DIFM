...
source("https://github.com/tmieno2/DIFM/blob/h_angle/Functions/functions_for_execution.R?raw=TRUE")
...
source("https://github.com/tmieno2/DIFM/blob/h_angle/Functions/functions_for_trial_design.R?raw=TRUE")
