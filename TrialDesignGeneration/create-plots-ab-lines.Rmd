...
#=== update side_plots_num ===#
# avoid plots to close to the boundary for the input with a greater plot width
if (nrow(trial_data_rh) > 1) {
  plot_width_1 <- trial_data_rh[1, input_plot_width]
  plot_width_2 <- trial_data_rh[2, input_plot_width]
  if (plot_width_1 < plot_width_2) {
    side_plots_num <- plot_width_2 / plot_width_1
  }
}
